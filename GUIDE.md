...
<!-- page -->
A port itself is a small node, not a full block: it always reaches an arm toward whatever face you
placed it against, and grows more of them toward any Conduit or port touching its other sides.
<!-- page -->
