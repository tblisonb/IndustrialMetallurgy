...
public class IndustrialMetallurgyClient {
    public IndustrialMetallurgyClient(ModContainer container) {
    ...
    static void onClientSetup(FMLClientSetupEvent event) {
        ...
        IndustrialMetallurgy.LOGGER.info("HELLO FROM CLIENT SETUP");
        IndustrialMetallurgy.LOGGER.info("MINECRAFT NAME >> {}", Minecraft.getInstance().getUser().getName());
    }
}
