...
// tough/fireproof) rather than by numbers. Nequitum is the unambiguous capstone, matching or
// beating netherite on every stat and carrying both bonuses at once.
public class ModArmorMaterials {
    ...
    public static final ResourceKey<EquipmentAsset> NEQUITUM_ASSET = assetId("nequitum");
    ...
    public static final ArmorMaterial NEQUITUM = new ArmorMaterial(
            45, defense(3, 6, 8, 3, 19), 15, SoundEvents.ARMOR_EQUIP_NETHERITE, 3.0F, 0.1F, itemTag("repairs_nequitum_armor"), NEQUITUM_ASSET);
