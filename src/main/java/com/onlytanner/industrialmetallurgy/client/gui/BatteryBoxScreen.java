...
// Reuses the Thermoelectric Generator's GUI texture (same flame/energy-bar layout) as a
// placeholder; no dedicated art exists for this machine yet.
public class BatteryBoxScreen extends AbstractContainerScreen<BatteryBoxContainer> {
    ...
    public BatteryBoxScreen(BatteryBoxContainer menu, Inventory playerInventory, Component title) {
